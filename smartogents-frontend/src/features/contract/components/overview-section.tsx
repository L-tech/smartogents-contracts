...
export const OverViewSection = ({
  ...
  const message =
    "Provide a comprehensive overview of the following smart contract based on its ABI. Include details on its functions, events, state variables, and any unique features.";
