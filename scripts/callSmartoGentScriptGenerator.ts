...
import ABI from "../abis/SmartoGentScriptGenerator.json";
...
async function main() {
    ...
    const contractAddress = process.env.SMARTO_GENT_SCRIPT_GENERATOR
  ...
  const transactionResponse = await contract.initiateScripGenerator(message, registryContract)
